...
const info = {
    ...
    ministry: "Ministry of Works and Infrastructural Development",
    description: "The Imo State Ministry of Works was established by the administration of His Excellency, Distinguished Senator Hope Uzodinma, the Governor of Imo State, to drive the reconstruction and modernization of infrastructure across the state. The Ministry is responsible for planning, constructing, and maintaining roads, bridges, and public facilities that support economic growth and improve the quality of life for all Imo citizens.",
...
export default function Footer() {
  ...
  return (
    ...
    <div className="mx-auto flex flex-col lg:flex-row justify-between gap-8 pb-8 max-w-5xl">
      ...
      Copyright © {new Date().getFullYear()} Imo State Ministry of Works and Infrastructural Development. All rights reserved. Powered by{' '}
      <a 
