...
const stats = [
  { value: 120, suffix: "+", desc: "Road Projects Completed" },
  { value: 350, suffix: "km", desc: "Roads Reconstructed Across the State" },
  { value: 27, suffix: "", desc: "Local Government Areas Impacted" },
  { value: 15, suffix: "", desc: "Major Bridges & Flyovers Delivered" },
];
