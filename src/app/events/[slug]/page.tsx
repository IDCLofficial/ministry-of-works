...
export default function EventDetailPage() {
  ...
  return (
    <>
      <TopHero
        ministryName="Ministry of Works"
        titleLabel="Events"
      />
      ...
      <div className="bg-white">
        ...
        <section className="w-full max-w-6xl mx-auto px-4 mb-12">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 text-sm">
            ...
            <div><span className="font-semibold">ORGANIZER:</span> <span className="ml-2">Imo State Ministry of Works and Infrastructural Development</span></div>
        ...
        <CTASection
          heading="Join Us."
          subtext="Be part of our mission in transformin Imo State."
