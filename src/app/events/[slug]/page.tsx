...
const event = {
  title: "Commissioning of Orlu–Owerri Dual‑Carriage Road",
  img: "/images/orlu‑owerri‑road.jpg",
  date: "10 October 2025",
  time: "10:00 am",
  organizer: "Ministry of Works, Imo State",
  phone: "Nil",
  address: "Orlu–Owerri Road, Orlu LGA, Imo State",
  description:
    "Governor Hope Uzodinma will officially inaugurate the newly reconstructed 12 km dual‑carriage section of the Orlu–Owerri highway. The project, executed under the Ministry of Works in partnership with the Nigeria Sovereign Investment Authority, aims to enhance regional trade, reduce travel time, and improve commuter safety. This commissioning marks a major milestone in Imo State’s ongoing infrastructure transformation efforts.",
};
